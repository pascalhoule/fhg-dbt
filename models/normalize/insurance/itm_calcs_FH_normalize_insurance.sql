...
SELECT
    ...
    FH_FINPOSTDATE,
    CASE
        WHEN FH_STATUSCATEGORY = 'PENDING' OR FH_STATUSNAMEENG = 'Inforce - Commission O/S' 
            THEN CURRENT_DATE
        WHEN
