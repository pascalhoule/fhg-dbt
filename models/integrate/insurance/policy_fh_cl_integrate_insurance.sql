...
SELECT
    ...
    INITCAP(COALESCE(B_COMM.AGENTNAME, B_COMM_INACTIVE.AGENTNAME,H_COMM.AGENTNAME, H_COMM.AGENTNAME))
    ...
    INITCAP(COALESCE(B_SERV.AGENTNAME, B_SERV_INACTIVE.AGENTNAME, H_SERV.AGENTNAME))
        AS FH_SERVICINGAGT_NAME

FROM POL_WITH_UD2
LEFT JOIN INTEGRATE.PROD_INSURANCE.HIERARCHY_FH_CL AS H_COMM
...
LEFT JOIN INTEGRATE.PROD_INSURANCE.HIERARCHY_FH_CL AS H_SERV
