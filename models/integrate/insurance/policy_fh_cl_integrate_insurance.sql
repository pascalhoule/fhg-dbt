...
SELECT
    ...
    COALESCE(NULLIF(FH_COMMISSIONINGAGT_USERDEFINED2, '-'), P.CL_Advisor_Group_Identifier) AS FH_COMM_SUPERUID,
    FH_SERVICINGAGT_USERDEFINED2,
    COALESCE(NULLIF(FH_SERVICINGAGT_USERDEFINED2, '-'), P.CL_Advisor_Group_Identifier) AS FH_SERV_SUPERUID,
