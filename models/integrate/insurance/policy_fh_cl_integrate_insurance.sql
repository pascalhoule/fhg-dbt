...
SELECT 
    ...
    try_cast (ADVISOR_AGREEMENT_GROUP_IDENTIFIER as VARCHAR) as FH_SERVICINGAGTCODE,
    null as FH_SERVICINGAGTSPLIT,
    CAST(ADVISOR_AGREEMENT_GROUP_IDENTIFIER as VARCHAR(50)) as FH_COMMISSIONINGAGTCODE,
