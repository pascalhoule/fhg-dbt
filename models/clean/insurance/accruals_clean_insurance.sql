...
select
    *,
    ...
    case
        when datalake_end_ts = '3000-01-01 00:00:00.000'
        then '9999-12-31 23:59:59'
        else datalake_end_ts
    end as _infx_active_to_ts_utc,
    case
        when datalake_end_ts = '3000-01-01 00:00:00.000' then true else false
