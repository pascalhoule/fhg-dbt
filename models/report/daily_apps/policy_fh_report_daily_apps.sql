{{			
    ...
    COALESCE(NULLIF(FH_COMMISSIONINGAGT_USERDEFINED2, '-'),CL_Advisor_Group_Identifier) AS FH_COMM_SUPERUID,
    ...
    COALESCE(NULLIF(FH_SERVICINGAGT_USERDEFINED2, '-'),CL_Advisor_Group_Identifier) AS FH_SERV_SUPERUID,
