...
SELECT
    ...
    ROUND(CASE WHEN AGENTCODE = 'Not Stitched' THEN 0 ELSE AGENTCODE END,0) AS FH_AGENTCODE,
    ROUND(CASE WHEN FH_UID = 'Not Stitched' THEN 0 ELSE FH_UID END,0) AS FH_USERDEFINED2,
    ADVISORNAME,
